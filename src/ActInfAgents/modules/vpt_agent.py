...
from ActInfAgents.modules.lib.policy import MinecraftAgentPolicy
from ActInfAgents.modules.lib.torch_util import (
    default_device_type,
...
class MineRLAgent:
    ...
    def _env_obs_to_agent(self, minerl_obs):
        ...
        print('agent input shape after _env_obs_to_agent', agent_input['img'].shape)
        return agent_input
