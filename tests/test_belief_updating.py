...
# from modules.energy_calc import Loss
# from modules.lib.action_head import create_action_head
# from modules.lib.action_mapping import CameraHierarchicalMapping
# from modules.lib.actions import ActionTransformer
# from modules.optim import OptimRegistry
# from modules.state import StateNode
# from modules.worldmodel import WorldModel

from .conftest import make_transition_model

def test_get_trans_model(make_transition_model):
